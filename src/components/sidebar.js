...
return (<div>
  <Modal modal={modal} close={closeModal} text={text} />
    <Nav background={darkMode? "black":"#156CEC"} >
      ...
      <a className="nav-item txt-md center-items" onClick={()=>  displayModal('Thank you for downloading my Resume')} href="https://github.com/aayush6194/aayush6194.github.io/raw/master/Resume.pdf"><i className="material-icons lg-icon ">account_circle</i><div>Resume</div></a>
