...
let Links =({darkMode})=> {
  ...
  <div className="grid-mobile align-left-on-lg">
    <a href="https://github.com/aayush6194">
      <button className={`bt bt-custom center-sm expand-sm ${darkMode? "dark-btn" : ""}`} >
      <i className="fab fa-github md-icon"></i>
      &nbsp; GitHub</button>
    </a>

    <a href="mailto:aayush6194@gmail.com">
     <button className={`bt bt-custom center-sm expand-sm ${darkMode? "dark-btn" : ""}`} > <i className="fa fa-envelope md-icon" aria-hidden="true"></i> &nbsp; Email</button>
    </a>
